...
import { changeBookNameMutation, ChangeBookNameInput, ChangeCategoryNameInput, changeCategoryNameMutation, EditEditionInput, editEditionMutation } from './mutationsBase';
